...
select ${yesterday}, 112, tt1.ref, tt1.pv, tt1.uv, coalesce(tt2.pay_pv, 0), coalesce(tt2.pay_uv, 0), tt2.new_order_count, tt2.xufei_order_count, tt2.new_income, tt2.xufei_income from (
...
) tt2 on tt1.ref = tt2.ref limit 500 
