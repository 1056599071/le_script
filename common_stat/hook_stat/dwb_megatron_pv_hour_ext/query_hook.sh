...
select ${yesterday}, 112, tt1.ref, tt1.pv, tt1.uv, tt2.pay_pv, tt2.pay_uv, tt2.new_order_count, tt2.xufei_order_count, tt2.new_income, tt2.xufei_income from (
...
) tt2 on tt1.ref = tt2.ref order by tt2.pay_uv desc
